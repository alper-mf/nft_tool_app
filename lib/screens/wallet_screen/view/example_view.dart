...
import 'package:nft_tool_app/screens/wallet_screen/controller/eth_conversions.dart';
import 'package:nft_tool_app/screens/wallet_screen/view/qr_scan_view.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _connectToPreviousSession() {
    ...
    _sessionStore =
        _sessionSaved != null ? WCSessionStore.fromJson(jsonDecode(_sessionSaved)) : null;
  ...
  _onTransaction({
    ...
    try {
      ...
      final maibiFunctions =
          contract.functions.where((element) => listEquals<int>(element.selector, funcBytes));
  ...
  Transaction _wcEthTxToWeb3Tx(WCEthereumTransaction ethereumTransaction) {
    return Transaction(
      ...
      maxGas:
          ethereumTransaction.gasLimit != null ? int.tryParse(ethereumTransaction.gasLimit!) : null,
